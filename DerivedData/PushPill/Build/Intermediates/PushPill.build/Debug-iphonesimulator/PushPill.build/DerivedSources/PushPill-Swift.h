...
@interface DoctorPillAddViewController : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified amountField;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified daysOfWeekTextField;
@property (nonatomic, strong) IBOutlet UISegmentedControl * _Null_unspecified timeSegmentedControl;
@property (nonatomic, strong) IBOutlet UITextView * _Null_unspecified noteTextView;
